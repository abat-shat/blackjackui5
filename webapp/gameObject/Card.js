sap.ui.define([], function(){
    class Card {
        ...
        /**
         * @type {int}
         * Current value of the card. Is the same as the face value, 
         * except for Ace, which can have either 1 or 11. However due to bad
         * design choices, new Ace value of 1 will not be stored here, but
         * will be determined automatically during hand score calculation.
         */
        #currentValue;
        /**
         * @type {string}
